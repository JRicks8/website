...
mainGame.onSwitchTo = (
  async function () {
    ...
    animImages[0].src = '../src/assets/frogbiz/anim-loading-0.png';
    animImages[1].src = '../src/assets/frogbiz/anim-loading-1.png';
    animImages[2].src = '../src/assets/frogbiz/anim-loading-2.png';
    // load images into bitmaps
    let loadedImages = 0;
    let images = [
      paperStack0 = new Image(),
      paperStack1 = new Image(),
      paperStack2 = new Image(),
      paperStack3 = new Image(),
      paperStackStamped0 = new Image(),
      paperStackStamped1 = new Image(),
      paperStackStamped2 = new Image(),
      paperStackStamped3 = new Image(),
      backgroundImage = new Image(),
      flowerPotImage = new Image(),
      flowerWiltedImage = new Image(),
      stampImage = new Image(),
      stampPadImage = new Image(),
      donut0Image = new Image(),
      donut1Image = new Image(),
      donut2Image = new Image(),
      bossImage = new Image(),
      coffeeMImage = new Image(),
      coffeeStreamImage = new Image(),
      computerImage = new Image(),
      deskImage = new Image(),
      elbowImage = new Image(),
      emailImage = new Image(),
      forearmImage = new Image(),
      handImage = new Image(),
      headDerp = new Image(),
      headDown = new Image(),
      headEat = new Image(),
      ...
      headRight = new Image(),
      headULeft = new Image(),
      headURight = new Image(),
      keyboardImage = new Image(),
      mugEmptyImage = new Image(),
      mugFullImage = new Image(),
      phoneImage = new Image(),
      phoneBoxImage = new Image(),
      shoulderImage = new Image(),
      sprayBottleImage = new Image(),
      torsoImage = new Image(),
      upperarmImage = new Image(),
      textDonutFail = new Image(),
      textEmailFail = new Image(),
      textFlowerFail = new Image(),
      textPhoneFail = new Image(),
      textWaveFail = new Image(),
      textPapersFail = new Image(),
      textFired = new Image(),
      textStop = new Image(),
      textboxImage = new Image(),
      day0Dialogue0 = new Image(),
      day0Dialogue1 = new Image(),
      day0Dialogue2 = new Image(),
      day0Dialogue3 = new Image(),
      day0Dialogue4 = new Image(),
      day1Dialogue0 = new Image(),
      day1Dialogue1 = new Image(),
      day1Dialogue2 = new Image(),
      day1Dialogue3 = new Image(),
      day1Dialogue4 = new Image(),
      day1Dialogue5 = new Image(),
      day1Dialogue6 = new Image(),
      day1Dialogue7 = new Image(),
      day1Dialogue8 = new Image(),
      day1Dialogue9 = new Image(),
      day1Dialogue10 = new Image(),
      day2Dialogue0 = new Image(),
      day2Dialogue1 = new Image(),
      day2Dialogue2 = new Image(),
      day2Dialogue3 = new Image(),
      day2Dialogue4 = new Image(),
      day2Dialogue5 = new Image(),
      day2Dialogue6 = new Image(),
      day2Dialogue7 = new Image(),
      day2Dialogue8 = new Image(),
      day3Dialogue0 = new Image(),
      day3Dialogue1 = new Image(),
      day3Dialogue2 = new Image(),
      day3Dialogue3 = new Image(),
      day3Dialogue4 = new Image(),
      day3Dialogue5 = new Image(),
      day3Dialogue6 = new Image(),
      day3Dialogue7 = new Image(),
      day3Dialogue8 = new Image(),
      day4Dialogue0 = new Image(),
      day4Dialogue1 = new Image(),
      day4Dialogue2 = new Image(),
      day4Dialogue3 = new Image(),
      day4Dialogue4 = new Image(),
      day4Dialogue5 = new Image(),
      day4Dialogue6 = new Image(),
      day4Dialogue7 = new Image(),
      day4Dialogue8 = new Image(),
      day4Dialogue9 = new Image(),
      day4Dialogue10 = new Image(),
      day4Dialogue11 = new Image(),
      day4Dialogue12 = new Image(),
      day4Dialogue13 = new Image(),
      day4Dialogue14 = new Image(),
      day4Dialogue15 = new Image(),
      day4Dialogue16 = new Image(),
      day4Dialogue17 = new Image(),
      day4Dialogue18 = new Image(),
      day4Dialogue19 = new Image(),
      pauseButtonImage = new Image(),
      retryButtonImage = new Image(),
      resumeButtonImage = new Image(),
      exitButtonImage = new Image(),
    ];
    {
      backgroundImage.src = '../src/assets/frogbiz/background.png';
      paperStack0.src = '../src/assets/frogbiz/paper-stack-0.png';
      paperStack1.src = '../src/assets/frogbiz/paper-stack-1.png';
      paperStack2.src = '../src/assets/frogbiz/paper-stack-2.png';
      paperStack3.src = '../src/assets/frogbiz/paper-stack-3.png';
      paperStackStamped0.src = '../src/assets/frogbiz/paper-stack-0-stamped.png';
      paperStackStamped1.src = '../src/assets/frogbiz/paper-stack-1-stamped.png';
      paperStackStamped2.src = '../src/assets/frogbiz/paper-stack-2-stamped.png';
      paperStackStamped3.src = '../src/assets/frogbiz/paper-stack-3-stamped.png';
      flowerPotImage.src = '../src/assets/frogbiz/flower-pot.png';
      flowerWiltedImage.src = '../src/assets/frogbiz/flower-wilted.png';
      stampImage.src = '../src/assets/frogbiz/stamp.png';
      stampPadImage.src = '../src/assets/frogbiz/stamp-pad.png';
      donut0Image.src = '../src/assets/frogbiz/donut-0-bite.png';
      donut1Image.src = '../src/assets/frogbiz/donut-1-bite.png';
      donut2Image.src = '../src/assets/frogbiz/donut-2-bite.png';
      bossImage.src = '../src/assets/frogbiz/boss.png';
      coffeeMImage.src = '../src/assets/frogbiz/coffee-machine.png';
      coffeeStreamImage.src = '../src/assets/frogbiz/coffee-stream.png';
      computerImage.src = '../src/assets/frogbiz/computer.png';
      deskImage.src = '../src/assets/frogbiz/desk.png';
      elbowImage.src = '../src/assets/frogbiz/elbow.png';
      emailImage.src = '../src/assets/frogbiz/email-notification.png';
      forearmImage.src = '../src/assets/frogbiz/forearm.png';
      handImage.src = '../src/assets/frogbiz/hand.png';
      headDerp.src = '../src/assets/frogbiz/head-derp.png';
      headDown.src = '../src/assets/frogbiz/head-down.png';
      headEat.src = '../src/assets/frogbiz/head-eat.png';
      headLeft.src = '../src/assets/frogbiz/head-left.png';
      headRight.src = '../src/assets/frogbiz/head-right.png';
      headULeft.src = '../src/assets/frogbiz/head-uleft.png';
      headURight.src = '../src/assets/frogbiz/head-uright.png';
      keyboardImage.src = '../src/assets/frogbiz/keyboard.png';
      mugEmptyImage.src = '../src/assets/frogbiz/mug-empty.png';
      mugFullImage.src = '../src/assets/frogbiz/mug-full.png';
      phoneImage.src = '../src/assets/frogbiz/phone.png';
      phoneBoxImage.src = '../src/assets/frogbiz/phonebox.png';
      shoulderImage.src = '../src/assets/frogbiz/shoulder.png';
      sprayBottleImage.src = '../src/assets/frogbiz/spray-bottle.png';
      torsoImage.src = '../src/assets/frogbiz/torso.png';
      upperarmImage.src = '../src/assets/frogbiz/upperarm.png';
      textDonutFail.src = '../src/assets/frogbiz/text-donutfail.png';
      textEmailFail.src = '../src/assets/frogbiz/text-emailfail.png';
      textFired.src = '../src/assets/frogbiz/text-fired.png';
      textFlowerFail.src = '../src/assets/frogbiz/text-flowerfail.png';
      textPhoneFail.src = '../src/assets/frogbiz/text-phonefail.png';
      textPapersFail.src = '../src/assets/frogbiz/text-papersfail.png';
      textStop.src = '../src/assets/frogbiz/text-stop.png';
      textWaveFail.src = '../src/assets/frogbiz/text-wavefail.png';
      textboxImage.src = '../src/assets/frogbiz/textbox.png';
      day0Dialogue0.src = '../src/assets/frogbiz/day0-dialogue0.png';
      day0Dialogue1.src = '../src/assets/frogbiz/day0-dialogue1.png';
      day0Dialogue2.src = '../src/assets/frogbiz/day0-dialogue2.png';
      day0Dialogue3.src = '../src/assets/frogbiz/day0-dialogue3.png';
      day0Dialogue4.src = '../src/assets/frogbiz/day0-dialogue4.png';
      day1Dialogue0.src = '../src/assets/frogbiz/day1-dialogue0.png';
      day1Dialogue1.src = '../src/assets/frogbiz/day1-dialogue1.png';
      day1Dialogue2.src = '../src/assets/frogbiz/day1-dialogue2.png';
      day1Dialogue3.src = '../src/assets/frogbiz/day1-dialogue3.png';
      day1Dialogue4.src = '../src/assets/frogbiz/day1-dialogue4.png';
      day1Dialogue5.src = '../src/assets/frogbiz/day1-dialogue5.png';
      day1Dialogue6.src = '../src/assets/frogbiz/day1-dialogue6.png';
      day1Dialogue7.src = '../src/assets/frogbiz/day1-dialogue7.png';
      day1Dialogue8.src = '../src/assets/frogbiz/day1-dialogue8.png';
      day1Dialogue9.src = '../src/assets/frogbiz/day1-dialogue9.png';
      day1Dialogue10.src = '../src/assets/frogbiz/day1-dialogue10.png';
      day2Dialogue0.src = '../src/assets/frogbiz/day2-dialogue0.png';
      day2Dialogue1.src = '../src/assets/frogbiz/day2-dialogue1.png';
      day2Dialogue2.src = '../src/assets/frogbiz/day2-dialogue2.png';
      day2Dialogue3.src = '../src/assets/frogbiz/day2-dialogue3.png';
      day2Dialogue4.src = '../src/assets/frogbiz/day2-dialogue4.png';
      day2Dialogue5.src = '../src/assets/frogbiz/day2-dialogue5.png';
      day2Dialogue6.src = '../src/assets/frogbiz/day2-dialogue6.png';
      day2Dialogue7.src = '../src/assets/frogbiz/day2-dialogue7.png';
      day2Dialogue8.src = '../src/assets/frogbiz/day2-dialogue8.png';
      day3Dialogue0.src = '../src/assets/frogbiz/day3-dialogue0.png';
      day3Dialogue1.src = '../src/assets/frogbiz/day3-dialogue1.png';
      day3Dialogue2.src = '../src/assets/frogbiz/day3-dialogue2.png';
      day3Dialogue3.src = '../src/assets/frogbiz/day3-dialogue3.png';
      day3Dialogue4.src = '../src/assets/frogbiz/day3-dialogue4.png';
      day3Dialogue5.src = '../src/assets/frogbiz/day3-dialogue5.png';
      day3Dialogue6.src = '../src/assets/frogbiz/day3-dialogue6.png';
      day3Dialogue7.src = '../src/assets/frogbiz/day3-dialogue7.png';
      day3Dialogue8.src = '../src/assets/frogbiz/day3-dialogue8.png';
      day4Dialogue0.src = '../src/assets/frogbiz/day4-dialogue0.png';
      day4Dialogue1.src = '../src/assets/frogbiz/day4-dialogue1.png';
      day4Dialogue2.src = '../src/assets/frogbiz/day4-dialogue2.png';
      day4Dialogue3.src = '../src/assets/frogbiz/day4-dialogue3.png';
      day4Dialogue4.src = '../src/assets/frogbiz/day4-dialogue4.png';
      day4Dialogue5.src = '../src/assets/frogbiz/day4-dialogue5.png';
      day4Dialogue6.src = '../src/assets/frogbiz/day4-dialogue6.png';
      day4Dialogue7.src = '../src/assets/frogbiz/day4-dialogue7.png';
      day4Dialogue8.src = '../src/assets/frogbiz/day4-dialogue8.png';
      day4Dialogue9.src = '../src/assets/frogbiz/day4-dialogue9.png';
      day4Dialogue10.src = '../src/assets/frogbiz/day4-dialogue10.png';
      day4Dialogue11.src = '../src/assets/frogbiz/day4-dialogue11.png';
      day4Dialogue12.src = '../src/assets/frogbiz/day4-dialogue12.png';
      day4Dialogue13.src = '../src/assets/frogbiz/day4-dialogue13.png';
      day4Dialogue14.src = '../src/assets/frogbiz/day4-dialogue14.png';
      day4Dialogue15.src = '../src/assets/frogbiz/day4-dialogue15.png';
      day4Dialogue16.src = '../src/assets/frogbiz/day4-dialogue16.png';
      day4Dialogue17.src = '../src/assets/frogbiz/day4-dialogue17.png';
      day4Dialogue18.src = '../src/assets/frogbiz/day4-dialogue18.png';
      day4Dialogue19.src = '../src/assets/frogbiz/day4-dialogue19.png';
      pauseButtonImage.src = '../src/assets/frogbiz/pause-button.png';
      retryButtonImage.src = '../src/assets/frogbiz/retry-button.png';
      resumeButtonImage.src = '../src/assets/frogbiz/resume-button.png';
      exitButtonImage.src = '../src/assets/frogbiz/exit-button.png';
    }
    ...
    // UI OBJECTS ////////////////////////////////////////////////////////////////////
    pauseButton = new UIElement(new Vector2(5, 255), new Vector2(40, 40));
    ...
    resumeButton = new UIElement(new Vector2(125, 80), new Vector2(153, 56));
    ...
    exitButton = new UIElement(new Vector2(125, 180), new Vector2(153, 56));
    ...
    retryButton = new UIElement(new Vector2(125, 80), new Vector2(153, 56));
...
mainMenu.onSwitchTo = (
  async function () {
    ...
    let images = [
      ...
      aboutButtonImage = new Image(),
      playStoryButtonImage = new Image(),
      playEndlessButtonImage = new Image(),
      menuBackgroundImage = new Image(),
      menuBackButtonImage = new Image(),
      menuTitleImage = new Image(),
      aboutTextImage = new Image(),
    ];
    playButtonImage.src = '../src/assets/frogbiz/play-button.png';
    aboutButtonImage.src = '../src/assets/frogbiz/about-button.png';
    playStoryButtonImage.src = '../src/assets/frogbiz/play-story.png';
    playEndlessButtonImage.src = '../src/assets/frogbiz/play-endless.png';
    menuBackgroundImage.src = '../src/assets/frogbiz/menu-background.png';
    menuBackButtonImage.src = '../src/assets/frogbiz/back-button.png';
    menuTitleImage.src = '../src/assets/frogbiz/menu-title.png';
    aboutTextImage.src = '../src/assets/frogbiz/about-text.png';
    for (let i = 0; i < images.length; i++) {
      images[i].onload = () => {
        Promise.resolve(createImageBitmap(images[i])).then(() => {
          loadedImages++;
    ...
    mainMenu.gameObjects = [
      mainScreenBackground = new GameObject(new Vector2(), new Vector2(400, 300), menuBackgroundImage),
      playScreenBackground = new GameObject(new Vector2(0, 300), new Vector2(400, 300), menuBackgroundImage),
      aboutScreenBackground = new GameObject(new Vector2(400, 0), new Vector2(400, 300), menuBackgroundImage),
      titleSplash = new GameObject(new Vector2(), new Vector2(400, 300), menuTitleImage),
      aboutText = new GameObject(new Vector2(400, 0), new Vector2(400, 300), aboutTextImage),
    ];
    // declare and initialize UI elements
    mainMenu.UIObjects = [
      playButton = new UIElement(new Vector2(125, 120), new Vector2(154, 56)),
      playBackButton = new UIElement(new Vector2(40, 340), new Vector2(72, 64)),
      playStoryButton = new UIElement(new Vector2(125, 380), new Vector2(154, 56)),
      playEndlessButton = new UIElement(new Vector2(125, 480), new Vector2(154, 56)),
      aboutButton = new UIElement(new Vector2(125, 190), new Vector2(154, 56)),
      aboutBackButton = new UIElement(new Vector2(440, 40), new Vector2(72, 64)),
      bestScoreLabel = new TextObject('Best Score: ' + saveData.bestEndlessScore),
      currentStoryDayLabel = new TextObject('Day ' + (saveData.currentStoryDay + 1) + '/5'),
    ];
